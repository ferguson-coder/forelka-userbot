...
Forelka v{FORELKA_VERSION} | Git: #{git}
""")

    # Отправляем уведомление о старте в "Логи"
    start_text = (
        f"<emoji id=5897962422169243693>👻</emoji> <b>Forelka Userbot Started</b>\n\n"
    ...
    try:
        ...
        stop_text = (
            f"<emoji id=5897962422169243693>👻</emoji> <b>Forelka Userbot Stopped</b>\n\n"
            f"<blockquote><b>Version:</b> <code>{FORELKA_VERSION}</code>\n"
