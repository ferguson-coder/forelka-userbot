...
async def backup_cmd(client, message, args):
    ...
    await message.edit(
        "<emoji id=5897962422169243693>👻</emoji> <b>Создаю бекап...</b>",
        parse_mode='html'
    )
    ...
    try:
            ...
            if os.path.exists(config_path):
                try:
                    ...
                    if group_id and topic_id:
                        ...
                        caption = (
                            f"<emoji id=5897962422169243693>👻</emoji> <b>Forelka Backup</b>\n\n"
        ...
        if sent:
            await message.edit(
                f"<emoji id=5897962422169243693>👻</emoji> <b>Бекап создан</b>\n\n"
...
async def restore_cmd(client, message, args):
    ...
    try:
        await message.edit(
            "<emoji id=5897962422169243693>👻</emoji> <b>Загрузка бекапа...</b>",
            parse_mode='html'
        )
        backup_path = await reply.download_media()

        await message.edit(
            "<emoji id=5897962422169243693>👻</emoji> <b>Распаковка бекапа...</b>",
            parse_mode='html'
        )
        ...
        backup_path = None
        await message.edit(
            "<emoji id=5897962422169243693>👻</emoji> <b>Бекап восстановлен</b>\n\n"
